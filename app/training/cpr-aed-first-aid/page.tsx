...
const course = COURSES.find((c) => c.slug === 'cpr-aed-first-aid')!;

export const metadata: Metadata = {
  title: 'CPR / AED & First Aid Certification | SIWD Foundation - 501(c)(3) Nonprofit',
  description:
    'Supporting Individuals with Disabilities Foundation Inc. offers the CPR / AED & First Aid Certification course for $60 in Yulee, FL. Certification covering adult, child and infant CPR, AED operation and First Aid response for caregivers and direct care staff.',
};

export default function CprAedFirstAidPage() {
  return (
    <>
