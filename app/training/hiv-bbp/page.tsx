...
const course = COURSES.find((c) => c.slug === 'hiv-bbp')!;

export const metadata: Metadata = {
  title: 'HIV / BBP Course | SIWD Foundation - 501(c)(3) Nonprofit',
  description:
    'Supporting Individuals with Disabilities Foundation Inc. offers the HIV / BBP course for $35 in Yulee, FL. Master HIV and Bloodborne Pathogen safety, exposure control, prevention and post-exposure procedures.',
};
